...
### 核心定理
![[../../../../pic/Pasted image 20250815173833.png]]
意思是一个**有限**的多元函数，可以拆分成多个**一元函数**和**加法**，奇妙的是，只需要加法即可，不需要乘除开方等复杂操作
一元函数的优势： 可以使用曲线描绘，可视化比较清楚，同时可以通过多个函数求和拟合

### network架构
![[../../../../pic/Pasted image 20250815175217.png|Pasted image 20250815175217.png]]
...
- silu是[[../../基础理论/神经网络组件/激活函数/sigmoid.md|sigmoid]]函数的一个变体
#### 贝塞尔函数
![[../../../../pic/Pasted image 20250818225045.png|Pasted image 20250818225045.png]]
